...
import type { SurveyResponseInput } from '../routes/survey.routes';
...
export const surveyService = {
  async create(input: SurveyResponseInput, meta: InsertMeta): Promise<{ id: string }> {
    ...
    // postgres-js's sql.json(...) marks the value as a jsonb literal; plain
    // ${array} would otherwise be sent as a Postgres array. Per
    // drafts.service.ts this is the existing idiom for jsonb columns.
